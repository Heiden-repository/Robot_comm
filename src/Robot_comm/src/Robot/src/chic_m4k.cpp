...
void Chic_m4k::send_serial()
{
    ...
    // std::stringstream Linear_velocity_hex;
    // std::stringstream angular_velocity_hex;

    // Linear_velocity_hex << std::hex << Linear_velocity;
    // angular_velocity_hex << std::hex << angular_velocity;
